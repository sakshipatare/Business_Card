  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md">
        ...
        <p className="text-gray-600 text-center mb-6">Sign in to access your digital business card</p>
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className="options">
            ...
            <a href="#" className="text-[#007bff] font-medium hover:text-[#0056b3] transition-colors duration-300">Forgot password?</a>
          </div>
